      ...
      <div className="text-center mx-auto flex-1">
        <div className="relative mx-auto h-48 w-full">
          <div
            style={{
              ...MaskStyling,
              background: selectedBackgroundColor.light,
            }}
            className="rounded-full absolute inset-x-auto z-0 inline-block left-0 right-0"
          />
          <div
          ...
          >
            <ProgressiveImage
              ...
              render={(src, style) => (
                <img src={src} style={style} alt={`Name - ${pokemon.name}`} />
              )}
            />
          </div>
        </div>

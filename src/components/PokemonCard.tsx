...
//! new type alias assigned to our global Pokemon type
type Props = Pokemon;

function PokemonCard({ id, name, sprites, types }: Props) {
  const history = useHistory();
  const backgroundColors = types.map(({ type }) => {
    /* Object entries will return an array, with obj value being 1st indx */
